...
gmx_mpi pdb2gmx -f npt.gro -o peptoid.gro -p topol.top -water spce -ff charmm36-feb2021 -ter  
...
gmx_mpi insert-molecules -ci peptoid.gro -o box.gro -nmol $NMOL -box $DIMS $DIMS $DIMS
